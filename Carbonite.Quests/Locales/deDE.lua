if ( GetLocale() ~= "deDE" ) then -- erste Übersetzungen bitte überprüfen
	return;
end
...
L["Use Alt-L instead of L for Carbonite Quests"] = "Carbonite Quests mit ALT-L anstatt L \195\182ffnen"
L["When enabled, leaves L as the default blizzard window and Alt-L for carbonite quests"] = "Wenn eingestellt, wird das BlizzardquestUI mit L und das CarboniteQuestUI mit ALT-L ge\195\182ffnet." 
L["Show Quests Side by Side"] = "Quests nebeneinander anzeigen"
L["When enabled, shows the quest details to the right side of the quest window"] = "Wenn eingestellt, werden die Questdetails rechts neben dem Questfenster angezeigt." 
...
L["When enabled, will auto accept quests that get offered to you"] = "Wenn eingestellt, werden Quests automatisch angenommen, welche angeboten werden"
L["Auto Turn In Quests"] = "Quests automatisch abgeben"
L["When enabled, automatically turns in quests"] = 
